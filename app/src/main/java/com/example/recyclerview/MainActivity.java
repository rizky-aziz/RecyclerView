...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names = {"I Took A Pil In Ibiza", "7 Years", "Pillow Talk", "Work From Home", "Never Forget You", "Don't Let Me Down", "Lover Yourself", "Me, Myself & I", "Cake By The Ocean", "Dangerous Woman", "My House", "Stressed Out", "One Dance", "Middle", "No" };

    String[] singers = {"Mike Posner", "Lukas Graham", "Zayn", "Fifth Harmony", "Zara Larson & MNEK", "The Chainsmokers", "Justin Bieber", "G-Eazy x Bebe Rexha", "DNCE", "Ariana Grande", "Flo Rida", "Twenty one pilots", "Drake", "DJ Snake", "Meghan Trainer"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int positon) {
                Toast.makeText(MainActivity.this, "Card at " + positon + " is clicked", Toast.LENGTH_SHORT).show();
            }
        }));
    }
